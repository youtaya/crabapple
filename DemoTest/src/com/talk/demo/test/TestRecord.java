...
public class TestRecord extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testInputLogin() {
        ...
        tr1.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr1.getTimeRecord().setLink("abc");
        mgr.addTime(tr1);
        
        String c2 = "I come to talk with you again";
        TimeRecord tr2 = new TimeRecord(c2, date2);
        tr2.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr2.getTimeRecord().setLink("abc");
        mgr.addTime(tr2);
        
        String c3 = "Because a vision softly creeping";
        TimeRecord tr3 = new TimeRecord(c3, date3);
        tr3.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr3.getTimeRecord().setLink("abc");
        mgr.addTime(tr3);
        
        String c4 = "Left its seeds while I was sleeping";
        TimeRecord tr4 = new TimeRecord(c4, date4);
        tr4.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr4.getTimeRecord().setLink("abc");
        mgr.addTime(tr4);
        
        String c5 = "And the vision that was planted in my brain";
        TimeRecord tr5 = new TimeRecord(c5, date5);
        tr5.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr5.getTimeRecord().setLink("abc");
        mgr.addTime(tr5);
        
        String c6 = "Still remains ";
        TimeRecord tr6 = new TimeRecord(c6, date6);
        tr6.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr6.getTimeRecord().setLink("abc");
        mgr.addTime(tr6);
        
        String c7 = "Within the sound of silence";
        TimeRecord tr7 = new TimeRecord(c7, date7);
        tr7.getTimeRecord().setContentType(TalkUtil.MEDIA_TYPE_TEXT);
        tr7.getTimeRecord().setLink("abc");
        mgr.addTime(tr7);
